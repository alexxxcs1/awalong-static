...
var gameframe = 
{
	...
	createRoundtable:function()
	{
		...
		if (this.extendRule&&this.nowround == 4) {
			var winNum = new Text();
			winNum.color = "#333333";
			winNum.font = "Impact";
			winNum.fontSize = 40;
			...
			},500,null,Handler.create(this,function()
			{
				setTimeout(function() {
					...
					if (!gameframe.gameResult(0)) {
						...
						gameframe.extendRule=false;
						gameframe.nowround = 0;
						gameframe.round = [0,0,0,0,0];
						gameframe.VotePool = [];
	...
	init:function(result)
	{
		...
		if (result) {
			...
			if (bA) {
					...
					_resulttext.text = '请 '+(bA)+' '+'号玩家出来刺杀梅林';
